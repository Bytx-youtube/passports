...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.veriff.veriff_flutter.VeriffFlutterPlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin veriff_flutter, com.veriff.veriff_flutter.VeriffFlutterPlugin", e);
    }
    try {
